...
const ValidLoanPopup = ({ openPopup, handleClosePopup, selectedRow }) => {
    ...
    if (selectedRow && pdfFile) {
      ...
      try {
        const response = await axios.put(
          `http://localhost:8000/api/Loanvalide/${selectedRow.id}`,
          formData,
          {
            headers: {
  ...
  return (
    ...
    >
      ...
      >
        <h3>Validation Du Demande De Prêt</h3>
      </DialogTitle>
